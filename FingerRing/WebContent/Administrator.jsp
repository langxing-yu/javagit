      ...
      <div class="dr_choose"> 
       ...
       <div class="drcho_top"> 
        <ul class="drchoose_ul"> 
         ...
         <a href="lists1.jsp"><li id="ucser_forever"><span>Forever 系列</span> </li> </a>
   	...
   	%>    
        ...
        <li>
         ...
         <div class="by_bottom">
          ...
          <p>操作   <a href="controller.jsp?gid=<%=good.getGid() %>">修改</a>&nbsp;   <a href="delete?gid=<%=good.getGid() %>&pageNum=<%=pageNum %>">删除</a></p>
         </div></li>
      <%
   		}
      %>
     ...
     <div class="paging_all" id="pageing_pagingDiv"> 
      <div class="paging_all-cort"> 
       ...
       %>
		...
		%>
				<li><a href="Administrator.jsp?pageNum=1">首页</a></li>
				<li class="pli pag_gray">&lt;&lt;<a href="Administrator.jsp?pageNum=<%=pageNum-1 %>">上一页</a></li>
		...
		%>
				<li class="pli2"><a href="Administrator.jsp?pageNum=<%=pageNum+1 %>">下一页</a>&gt;&gt;</li>
				<li><a href="Administrator.jsp?pageNum=<%=pageCount %>">末页</a></li>
		<% 
			}
		%>
