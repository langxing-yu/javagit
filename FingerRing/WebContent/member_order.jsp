...
<div class="member_cort-left fl">
    ...
    <div class="member_cortleft-tittle">
        <i class="mb_home"></i><a rel="nofollow" href="member_index.jsp">我的DR</a>
    </div>
    <!--我的DR end-->
    <ul class="member_cort-ul">
        <li>
            ...
            <ul class="member_ul-dr">
                <li class="speacil_color" id="ctl00_content_ucmemberleft_order"><a rel="nofollow" href="member_order.jsp">我的订单</a></li>
                <li id="ctl00_content_ucmemberleft_ask"><a rel="nofollow" href="/member/myevaluate.jsp">我要评价</a></li>
                <li id="ctl00_content_ucmemberleft_cart"><a rel="nofollow" href="cart.jsp" target="_blank">我的购物车</a></li>
                <li id="ctl00_content_ucmemberleft_collect"><a rel="nofollow" href="member_collect.jsp">我的收藏</a></li>
                <li class="no_border" id="ctl00_content_ucmemberleft_yuyue"><a rel="nofollow" href="/member/myappointment.jsp">我的预约</a></li>
            </ul>
        </li>
        <li>
            <h3>
                -售后服务-</h3>
            <ul class="member_ul-dr">
                <li id="ctl00_content_ucmemberleft_salAfter"><a rel="nofollow" href="/member/aftersale.jsp">售后办理</a></li>
        ...
        <li>
            <h3>
                -帐户管理-</h3>
            <ul class="member_ul-dr">
                <li id="ctl00_content_ucmemberleft_myinfo"><a rel="nofollow" href="member_info.jsp">个人信息</a></li>
                <li id="ctl00_content_ucmemberleft_password"><a rel="nofollow" href="member_pwd.jsp">修改密码</a></li>
                <li id="ctl00_content_ucmemberleft_address"><a rel="nofollow" href="member_addr.jsp">收货地址</a></li>
                <li id="ctl00_content_ucmemberleft_li_jnr"><a href="/member/mydr_jnr.jsp">纪念日维护</a></li>
                <li id="ctl00_content_ucmemberleft_zhuanshu">
                    <a href="/member/DarryHome.aspx"> 专属空间</a></li>
                <li class="no_border" id="ctl00_content_ucmemberleft_news"><a rel="nofollow" href="/member/mynews.jsp">系统消息</a></li>
            </ul>
        </li>
    </ul>
</div>
	...
	<tbody> 
        ...
        <tr class="member_myorder-table-third">
			...
			<td class="myorder-table_td3">
				<div style="height:55px;line-height:55px;font-family:微软雅黑;" class="myorder-table-third-cp">￥<%=good.getRate() %></div>
		    </td>
            <td style="font-family:微软雅黑;" class="myorder-table_td2">￥0 </td>
            <td class="myorder-table_td4"></td>
            <td class="myorder-table_td5">未处理</td>
            <td class="myorder-table_td6">
            	<a class="myorder-table_pay" href="pay.jsp?gid=<%=good.getGid() %>">支 付</a>
                <p><a href="detail.jsp?gid=<%=good.getGid() %>">查看</a></p>
