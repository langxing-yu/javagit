  ...
  <form id="aspnetForm" action="brand.jsp" method="post" name="aspnetForm"> 
   ...
   <div> 
    ...
    <div class="cort"> 
     ...
     <div class="cort"> 
      ...
      <div class="cmain culture_same"> 
       ...
       <div class="zbk_top spalid"> 
        <div class="zbk_top spalid"> 
         <span>您当前的位置：</span> 
         <span id="ctl00_content_website_SiteMapPath1"><a href="#ctl00_content_website_SiteMapPath1_SkipLink"></a><span> <a target="_blank" href="index.jsp">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <span>品牌文化</span> </span><a id="ctl00_content_website_SiteMapPath1_SkipLink"></a></span> 
        </div> 
       </div> 
       <!--面包屑end--> 
       <!--标题--> 
       ...
       <div class="culture_nav"> 
        <a href="brand.jsp">品牌文化</a> 
        <i>|</i> 
        <a href="brand.jsp_br">品牌理念</a> 
        <i>|</i> 
        <a target="_blank" href="brand.jsp_mr">名人推荐</a> 
        <i>|</i> 
        <a target="_blank" href="/shopyd">实体店</a> 
        <i>|</i> 
        <a href="brand.jsp_pz">品质工艺</a> 
        <i>|</i> 
        <a href="brand.jsp_tl">真爱验证</a> 
        <i>|</i> 
        <a target="_blank" href="http://bbs.darryring.com/">DR社区</a> 
        <i>|</i> 
        <a href="brand.jsp_jo">加入我们</a> 
        <i>|</i> 
       ...
       <div class="culture_pp culture_first"> 
        <!--左边--> 
        <div class="fl"> 
         <a target="_blank" href="/dr_brand.aspx"> <img width="470" height="300" src="images/wh1.jpg" /> </a> 
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_pp-word fr"> 
         ...
         <a class="to_more" target="_blank" href="brand.jsp_br">了解更多</a> 
        </div> 
        <!--右边end--> 
       </div> 
       <!--品牌理念end--> 
       <!--三大块--> 
       <div class="three_yz"> 
        <a href="index.jspbrand.jsp_tl" target="_blank"> <img width="300" height="426" src="images/re1.jpg" /> </a> 
        <a href="index.jspbrand.jsp_pr" target="_blank"> <img width="300" height="426" src="images/re2.jpg" /> </a> 
        <a href="index.jspbrand.jsp_zo" target="_blank"> <img width="300" height="426" src="images/re3.jpg" /> </a> 
       </div> 
       <!--三大块end--> 
       <!--社会名人--> 
       <div class="culture_pp culture_sec"> 
        ...
        <div class="culture_pp-word fl"> 
         ...
         <a class="to_more" target="_blank" href="brand.jsp_mr">了解更多</a> 
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_sec-right fr"> 
         <a target="_blank" href="dr_mrtj.aspx"> <img width="367" height="250" src="images/wh2.jpg" /> </a> 
        </div> 
        <!--右边end--> 
       </div> 
       <!--社会名人end--> 
       ...
       <div class="culture_pp culture_thrid"> 
        ...
        <div class="culture_thrid-left fl"> 
         <a target="_blank" href="/shopyd"> <img width="367" height="230" src="images/wh3.jpg" /> </a> 
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_pp-word fr"> 
       ...
       <div class="culture_pp"> 
        ...
        <div class="culture_four-left fl"> 
         ...
         <div class="professional_gy"> 
          ...
          <a class="to_more" target="_blank" href="brand.jsp_pz">了解更多</a> 
         </div> 
         <!--工艺end--> 
        </div> 
        <!--品质工艺end--> 
       ...
       <div class="culture_pp"> 
        ...
        <div class="culture_last fl"> 
         <a target="_blank" href="http://bbs.darryring.com"> <img width="465" height="200" src="images/wh6.jpg" /> </a> 
        </div> 
        <!--左边end--> 
        <!--右边--> 
        <div class="culture_last fr"> 
         <a target="_blank" href="brand.jsp_jo"> <img width="466" height="200" src="images/wh7.jpg" /> </a> 
        </div> 
        <!--右边end--> 
       </div> 
       <!--DR社区与加入我们end--> 
       ...
       <div class="culture_share"> 
        ...
        <div class="culture_share-it"> 
         ...
         <a class="cshare_4" href="http://share.v.t.qq.com/index.php?c=share&amp;a=index&amp;url=index.jspbrand.jsp&amp;title=&amp;appkey=333cf198acc94876a684d043a6b48e14"></a>
     ...
     <script>
        $("#wb").click(function () {
            var href = "http://service.weibo.com/share/share.php?title=品牌文化 &url=index.jspbrand.jsp";
