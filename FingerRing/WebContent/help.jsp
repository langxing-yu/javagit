...
/*https://shop116998991.taobao.com/*/-->
  ...
  <form id="aspnetForm" action="/help_se/49.jsp" method="post" name="aspnetForm"> 
      ...
      <div class="cmain aboutUs"> 
       ...
       <div class="about_center"> 
        ...
        <ul class="abc_left fl"> 
         <li> <h3> <a href="/help_ab.jsp">-关于我们-</a></h3> </li> 
         <li> <h3> <a href="help.jsp">-帮助中心-</a></h3> </li> 
         <li> <h3> -服务条款-</h3> 
          <!--里面的ul--> 
          <ul class="abul_ul"> 
           <li class="bau_other"> <h4> <a id="79" href="/help_se/79.jsp"> 修改手寸 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="80" href="/help_se/80.jsp"> 终生保养 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="81" href="/help_se/81.jsp"> 一钻双证 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="82" href="/help_se/82.jsp"> 钻石更换 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="83" href="/help_se/83.jsp"> 全程保险 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="84" href="/help_se/84.jsp"> 15天退换 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="85" href="/help_se/85.jsp"> 注册协议 </a> </h4> </li> 
           <li class="bau_other"> <h4> <a id="86" href="/help_se/86.jsp"> 隐私声明 </a> </h4> </li> 
          </ul> 
          <!--里面的ul end--> </li> 
        </ul> 
        <!--左边end--> 
