  ...
  <form id="form1" action="/darry_ring" method="post" name="form1"> 
      ...
      <div class="dr_choose"> 
       ...
       <div class="drcho_top"> 
        <ul class="drchoose_ul"> 
         <a href="lists.jsp"><li id="ucser_all"><span>所有</span> </li> </a>
         ...
         <a href="Truelists.jsp"><li class="choose_hover" style="background-image:none" id="ucser_truelove"><span>True Love系列</span> </li> </a>
        </ul> 
       </div> 
   ...
   <%
		...
		GoodsService gods = new GoodsService();
   		List<Goods> goods = gods.findGoodsByNameTrue();
