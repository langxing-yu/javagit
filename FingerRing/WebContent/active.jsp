...
<body>
	...
	<form id="form1" action="active.jsp" method="post" name="form1"> 
	<!--头部--> 
	<div class="cmain"> 
		<div class="headtop"> 
		<!--头部左边--> 
   ...
   <div class="cort"> 
    ...
    <div class="cmain newesthing"> 
     <div class="zbk_top spalid"> 
      <div class="zbk_top spalid"> 
       <span>您当前的位置：</span> 
       <span id="ctl05_SiteMapPath1"><a href="#ctl05_SiteMapPath1_SkipLink"></a><span> <a target="_blank" href="index.jsp">Darry Ring</a> </span><span> <em>&gt;</em> </span><span> <span>最新活动</span> </span><a id="ctl05_SiteMapPath1_SkipLink"></a></span> 
      </div> 
     </div> 
     <!--动态内容--> 
      ...
      <div id="div_all"> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <div> 
          <a target="_blank" href="index.jsp/ty.jsp"><img width="1000" height="330" src="images/201505291745509c39dad33b.jpg" alt="" /></a>
         </div> 
         <div>
           &nbsp;
         </div> 
         <div style="font-size:12px; color:#888888;"> 
          <span style=""><span style="font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 22px; ">唐嫣首登《时尚新娘》六月刊封面，并佩戴一生仅能定制一枚的Darry Ring（DR真爱戒指）璀璨臻品，化为幸福小女人。了解更多请点击<a href="index.jsp/ty.jsp">index.jsp/ty.jsp</a></span></span>
         </div> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/lyx.jsp"><img width="1000" height="330" src="images/20150528143230053145c1a7.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p> 
         <p> <span style="color: rgb(136, 136, 136); font-size: 12px;">在《芭莎珠宝》大片拍摄中，娄艺潇佩戴一生仅能定制一枚的DarryRing浪漫臻品，倾情演绎只因坚守真爱唯一的信念。更多详情点击<a href="index.jsp/lyx.jsp">index.jsp/lyx.jsp</a><br /> </span></p> 
         <p></p> 
        </div> 
       </div> 
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/suzstore"><img width="1000" height="330" src="images/2015052115224001b3d91235.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p> 
       ...
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <div> 
          <a target="_blank" href="index.jsp/xiaoshidai4.jsp"><img width="1000" height="330" src="images/2015061114302742b5f2b237.jpg" alt="" /></a>
         </div> 
         <div>
           &nbsp;
         </div> 
       ...
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/520.jsp"><img width="1000" height="330" src="images/20150513124231a10e2c5f1c.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p> 
       ...
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/520fg.jsp"><img width="1000" height="330" src="images/20150515151308d1c34c620f.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p> 
       ...
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/tjstore"><img width="1000" height="330" src="images/20150513103218ff0c3e5616.jpg" alt="Darry Ring武汉店即将开业" /></a><a target="_blank" href="index.jsp/csstore"><br /> </a></p> 
       ...
       <div class="newesthing_cort-activities"> 
        ...
        <div class="newesthing_cort-activities-word"> 
         <p> </p>
         <p> <a target="_blank" href="index.jsp/kmstore"><img width="1000" height="330" src="images/20150513103613f1bbb67d84.jpg" alt="Darry Ring武汉店即将开业" /><br /> </a></p> 
