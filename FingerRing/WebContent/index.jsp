      ...
      <li><a style="font-family:arial" href="lists.jsp">Darry Ring 求婚钻戒</a> 
       <div class="nav-div"> 
        <div class="navdiv_top"> 
         ...
         <div class="navdiv-left"> 
          <h3> NEW</h3> 
          <a href="detail.jsp"> <img width="138" height="97" alt="2克拉钻戒价格_E色EX切工VVS2净度_True Love系列 奢华款 _Darry Ring求婚钻戒 戴瑞珠宝官网" src="images/03wj.jpg" /></a> 
          <div class="more_cp"> 
           <a href="detail.jsp">&gt; 了解该系列产品</a> 
          </div> 
         </div> 
        </div> 
     ...
     <ul class="indexbanner"> 
      <li class="tb_first" style="display: block; opacity: 0.982279;"> 
       <div class="cmain cb_main"> 
        <a class="cb_jdt" target="_blank" href="index.jspbrand.jsp"></a> 
        <div class="banner-word sp_width"> 
         ...
         <div class="button sp_button"> 
          <div class="bt2">
           <a target="_blank" href="index.jspbrand.jsp">了解品牌文化</a>
          </div> 
         </div> 
        </div> 
       </div> </li> 
      <li class="tb_sec" style="display: list-item; opacity: 0.0177213;"> <a target="_blank" href="index.jsp/xiaoshidai4.jsp"> 
        <div class="cmain cb_main"> 
        </div> </a> </li> 
      <li class="tb_third" style="display: none;"> 
       <div class="cmain cb_main"> 
        <a class="cb_jdt" target="_blank" href="index.jspbrand.jsp_mr"></a> 
        <div class="button sp_button DRstar_more"> 
         <div class="bt2">
          <a target="_blank" href="index.jspbrand.jsp_mr">了解明星DR族</a>
         </div> 
        </div> 
       </div> </li> 
      <li class="tb_four" style="display: none;"> 
       <div class="cmain cb_main"> 
        <a class="cb_jdt" target="_blank" href="index.jsp/shopyd"></a> 
        <div class="banner-word sp_width"> 
         ...
         <div class="button sp_button"> 
          <div class="bt2">
           <a target="_blank" href="index.jsp/shopyd">预约到店</a>
          </div> 
         </div> 
         <div class="baner_shortline"> 
          <p>更多实体店持续开设.....</p> 
    ...
    <div class="all-thing"> 
     ...
     <div class="cmain"> 
      ...
      <ul class="news-ul"> 
       ...
       <li> 
        <div class="ul-top"> 
         <a target="_blank" href="brand.jsp"> <img width="235" height="130" alt="关于Darry Ring" src="images/zajz.jpg" /> </a> 
        </div> 
        <div class="ul-center"> 
         <a target="_blank" href="brand.jsp" class="">关于Darry Ring(DR真爱钻戒)</a> 
        </div> 
        <div class="ul-bottom"> 
        </div> </li> 
       <!--每一块li--> 
       <li> 
        <div class="ul-top"> 
         <a target="_blank" href="brand.jsp_mr"> <img width="235" height="130" alt="社会名人倾情推荐" src="images/famous.jpg" /> </a> 
        </div> 
        <div class="ul-center"> 
         <a target="_blank" href="brand.jsp_mr">明星 DR 族</a> 
        </div> 
        <div class="ul-bottom"> 
        </div> </li> 
       <!--每一块li--> 
       <li> 
        <div class="ul-top"> 
         <a target="_blank" href="lists.jsp"> <img width="235" height="130" alt="网络热门钻戒品牌" src="images/wlzj.jpg" /> </a> 
        </div> 
        <div class="ul-center"> 
         <a target="_blank" href="lists.jsp" class="">Darry Ring 定制</a> 
        </div> 
        <div class="ul-bottom"> 
        </div> </li> 
      </ul> 
      ...
      <ul class="all_tab"> 
       <li style="display: none;"> 
        ...
        <div class="tab_left fl"> 
         <a href="index.jsp/dr_series/12_22.jsp"> <img width="504" height="314" alt="Forever经典系列" src="images/fimg6.jpg" /> </a> 
        </div> 
        <!--tab选项卡下的左边内容 end--> 
        <!--tab选项卡下的右边内容--> 
        <div class="tab_right fr"> 
         ...
         <!--更多选择--> 
         <div class="more-ul"> 
          <p> <a target="_blank" href="/dr_series/12_22.jsp">求婚钻戒</a> <a target="_blank" href="dr_phonics">结婚对戒</a> <a target="_blank" href="/j_series/22_12.jsp">饰品</a> </p> 
         </div> 
        </div> 
        <!--tab选项卡下的右边内容  end--> </li> 
       <li style="display: none;"> 
       ...
       <li style="display: none;"> 
        <!--tab选项卡下的左边内容--> 
        <div class="tab_left fl"> 
         <a href="/dr_series/11_20.jsp"> <img width="504" height="314" alt="My heart系列" src="images/fimg2.jpg" /> </a> 
        </div> 
        <!--tab选项卡下的左边内容 end--> 
        <!--tab选项卡下的右边内容--> 
        <div class="tab_right fr"> 
         <a ><h3> My heart系列</h3> </a>
         <p> 将我的心刻入璀璨的钻石 呈献给最爱的你 </p> 
         <p> 此生只愿，把心交给你</p> 
         <div class="to_more"> 
          <div class="bt2"> 
           <a target="_blank" href="/dr_series/11_20.jsp">了解更多</a>
          </div> 
         </div> 
         <!--更多选择--> 
         <div class="more-ul"> 
          <p> <a target="_blank" href="/dr_series/11_20.jsp">求婚钻戒</a> <a target="_blank" href="dr_phonics"> 结婚对戒</a> <a target="_blank" href="/j_series/20_11.jsp">饰品</a> </p> 
         </div> 
        </div> 
        <!--tab选项卡下的右边内容  end--> </li> 
       <li style="display: list-item; opacity: 0.470565;"> 
        <!--tab选项卡下的左边内容--> 
        <div class="tab_left fl"> 
         <a href="/dr_series/16_30.jsp"> <img width="515" height="314" alt="True Love系列" src="images/fimg3.jpg" /> </a> 
        </div> 
        <!--tab选项卡下的左边内容 end--> 
        <!--tab选项卡下的右边内容--> 
        <div class="tab_right fr"> 
         ...
         <div class="to_more"> 
          <div class="bt2"> 
           <a target="_blank" href="/dr_series/16_30.jsp">了解更多</a>
          </div> 
         </div> 
         <!--更多选择--> 
         <div class="more-ul"> 
          <p> <a target="_blank" href="/dr_series/16_30.jsp">求婚钻戒</a> <a target="_blank" href="dr_phonics"> 结婚对戒</a> <a target="_blank" href="/j_series/30_16.jsp">饰品</a> </p> 
         </div> 
        </div> 
        <!--tab选项卡下的右边内容  end--> </li> 
       <li style="opacity: 0.529435; display: list-item;"> 
        <!--tab选项卡下的左边内容--> 
        <div class="tab_left fl"> 
         <a href="/dr_series/15_18.jsp"> <img width="504" height="314" alt="I Swear系列" src="images/fimg4.jpg" /> </a> 
        </div> 
        <!--tab选项卡下的左边内容 end--> 
        <!--tab选项卡下的右边内容--> 
        <div class="tab_right fr"> 
         ...
         <div class="to_more"> 
          <div class="bt2"> 
           <a target="_blank" href="/dr_series/15_18.jsp">了解更多</a>
          </div> 
         </div> 
         <!--更多选择--> 
         <div class="more-ul"> 
          <p> <a target="_blank" href="/dr_series/15_28.jsp">求婚钻戒</a> <a target="_blank" href="dr_phonics"> 结婚对戒</a> <a target="_blank" href="/j_series/28_15.jsp">饰品</a> </p> 
         </div> 
        </div> 
        <!--tab选项卡下的右边内容  end--> </li> 
      </ul> 
      ...
      <!--推荐款式--> 
      <div class="hot-ks"> 
       <a class="fr" target="_blank" href="lists.jsp">更多</a> 
      ...
      <div class="bkbook_left fl"> 
       ...
       <div class="bkbook_left-first"> 
        ...
        <div class="bkleft_img fl"> 
         <ul class="bkleft_banner"> 
          <li style="display: block;"><a target="_blank" href="/news/4827.jsp"> <img width="280px" height="180px" alt="小时代4剧情揭秘，杨幂戴DR真爱戒指或唯一存活" src="images/20150707185244af94e583ea.jpg" /> </a> 
           <!--提示文字--> 
           <div class="bnhide"> 
            <!--透明块--> 
           ...
           <!--提示文字end--> </li> 
          <li style="display: none;"><a target="_blank" href="/news/4825.jsp"> <img width="280px" height="180px" alt="最浪漫珠宝店Darry Ring7月7日登陆宁波" src="images/20150707184746fa95671549.jpg" /> </a> 
           <!--提示文字--> 
           <div class="bnhide"> 
            <!--透明块--> 
            <div class="banner_opa"> 
           ...
           <!--提示文字end--> </li> 
          <li style="display: none;"><a target="_blank" href="/news/4316.jsp"> <img width="280px" height="180px" alt="戴瑞戒指价格知多少 价值连城的一生承诺" src="images/20150707184853bf1307dd75.jpg" /> </a> 
           <!--提示文字--> 
           <div class="bnhide"> 
            <!--透明块--> 
            <div class="banner_opa"> 
        ...
        <!--右边列表--> 
        <ul class="bkfirst_ul"> 
         <li class="ts_list"> <h3> <a target="_blank" href="/news/4827.jsp"> 小时代4剧情揭秘，杨幂戴DR真爱戒指</a></h3> <p> 小时代4剧情即将揭秘!作为《小时代》电影系列大结局的收官之作，《小时代4灵魂...[<a href="/news/4827.jsp">详情</a>]</p> </li> 
         <li class=""> <h3> <a target="_blank" href="/news/4825.jsp"> 最浪漫珠宝店Darry Ring7月7日登陆宁</a></h3> <p> 7月7日，是阳历上和七夕节恰巧对应的日子，代表现代的宁波DR族和牛郎织女一样即...[<a href="/news/4825.jsp">详情</a>]</p> </li> 
         <li class=""> <h3> <a target="_blank" href="/news/4316.jsp"> 戴瑞戒指价格知多少 价值连城的一生</a></h3> <p> 香港戴瑞珠宝被誉为最浪漫珠宝品牌。然而，戴瑞珠宝更为大众所知晓的名字，其实...[<a href="/news/4316.jsp">详情</a>]</p> </li> 
        </ul> 
        <!--右边列表end--> 
       </div> 
       <!--第一块end--> 
       ...
       <div class="bkbook_left-sec"> 
        ...
        <ul class="bkbook_left-secul"> 
         <li><a class="fl" target="_blank" href="/news/3954.jsp"> 求婚钻戒第一品牌Darry R...</a> <span class="fr"> 2015/7/7</span> </li> 
         <li><a class="fl" target="_blank" href="/news/3534.jsp"> 求婚钻戒Darry Ring贵在...</a> <span class="fr"> 2015/7/7</span> </li> 
        </ul> 
        <!--左边ul end--> 
        <!--右边ul 求婚相关--> 
        <ul class="bkbook_left-secul bkbook_left-spcul"> 
         <li><a class="fl" target="_blank" href="/news/3042.jsp"> 2015年求婚告白词</a> <span class="fr"> 2015/7/7</span> </li> 
         <li><a class="fl" target="_blank" href="/news/2699.jsp"> 求婚买多大的钻戒合适?</a> <span class="fr"> 2015/7/7</span> </li> 
        </ul> 
        <!--右边ul end--> 
       </div> 
       <!--第二块end--> 
      ...
      <div class="bkbook_right fr"> 
       ...
       <div class="bkbook_right-allul"> 
        ...
        <div class="bkbook_right-fimg fl"> 
         <a target="_blank" href="/news/4293.jsp"> <img width="120" height="72" alt="网上买dr钻戒可不可靠" src="images/20150527154522510535113e.jpg" /> </a> 
        </div> 
        <!--左边图片end--> 
        <!--右边ul--> 
        <ul class="bkbook_left-secul bkbook_right-spcul"> 
         <li><a href="/news/4293.jsp"> 网上买dr钻戒可不可靠</a> </li> 
         <li><a href="/news/4273.jsp"> 0.9克拉钻石直径多少</a> </li> 
         <li><a href="/news/4258.jsp"> 玫瑰金可以做什么用</a> </li> 
        </ul> 
        <!--右边ul end--> 
       </div> 
       <!--第一块end--> 
       ...
       <div class="bkbook_right-allul"> 
        <!--左边图片--> 
        <div class="bkbook_right-fimg fl"> 
         <a target="_blank" href="/news/3870.jsp"> <img width="120" height="72" alt="一克拉钻戒保值" src="images/2015042918212650e2902a39.jpg" /> </a> 
        </div> 
        <!--左边图片end--> 
        <!--右边ul--> 
        <ul class="bkbook_left-secul bkbook_right-spcul"> 
         <li><a href="/news/3870.jsp"> 一克拉钻戒保值</a> </li> 
         <li><a href="/news/2452.jsp"> 女生如何挑选珠宝首饰?</a> </li> 
         <li><a href="/news/2127.jsp"> 佩戴珠宝首饰注意事项</a> </li> 
        </ul> 
        <!--右边ul end--> 
       </div> 
       <!--第二块end--> 
       ...
       <div class="bkbook_right-allul"> 
        <!--左边图片--> 
        <div class="bkbook_right-fimg fl"> 
         <a target="_blank" href="/news/4547.jsp"> <img width="120" height="72" alt="陆烧林萧求婚戒指是什么" src="images/2015061813430589cb642ca7.jpg" /> </a> 
        </div> 
        <!--左边图片end--> 
        <!--右边ul--> 
        <ul class="bkbook_left-secul bkbook_right-spcul"> 
         <li><a href="/news/4547.jsp"> 陆烧林萧求婚戒指是什么</a> </li> 
         <li><a href="/news/4354.jsp"> 婚戒一般尺寸</a> </li> 
         <li><a href="/news/4322.jsp"> 求婚戒指戴哪个手指比较好</a> </li> 
        </ul> 
        <!--右边ul end--> 
       </div> 
       <!--第三块end--> 
